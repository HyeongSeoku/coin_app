...
export const getTop100CoinTickers = () => axios.get(`${BASE_URL}/v1/tickers`).then((res) => res.data.splice(0, 100))

export const getCoinTickers = () => axios.get(`${BASE_URL}/v1/tickers`).then((res) => res.data)
...
export const get300CoinTickers = () => axios.get(`${BASE_URL}/v1/tickers`).then((res) => res.data.splice(0, 300))

export const getSpecificCoinTicker = (name: string) =>
  axios.get(`${BASE_URL}/v1/tickers`).then((res) => res.data.find((item: ITickerProps) => item.name === name))
